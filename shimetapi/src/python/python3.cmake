...
set(PYTHON3_OUTPUT_DIR ./output_modules/)
file(MAKE_DIRECTORY PYTHON3_OUTPUT_DIR)
set(GET_PREFERED_SITE_PACKAGES ${CMAKE_CURRENT_SOURCE_DIR}/get_prefered_site_packages.py)
...
if (COMPILE_PYTHON3_BINDINGS)
	...
	message(STATUS "TEST11111111:-----${PYTHON_${_python_version}_MODULE_EXTENSION}")
	# disable the suffix
	set(PYTHON_${_python_version}_MODULE_EXTENSION ".so")
        ...
        execute_process(
            ...
            COMMAND "${PYTHON_${_python_version}_EXECUTABLE}" "${GET_PREFERED_SITE_PACKAGES}" "--site-type" "system"
            OUTPUT_VARIABLE PYTHON_${_python_version}_SYSTEM_SITE_PACKAGES
            OUTPUT_STRIP_TRAILING_WHITESPACE
        )
        message(STATUS "HERE we have SITEPACKAGE:  ${PYTHON_${_python_version}_SYSTEM_SITE_PACKAGES}")
        ...
        if (PYTHON3_SITE_PACKAGES)
            ...
            execute_process(
                ...
                COMMAND "${PYTHON_${_python_version}_EXECUTABLE}" "${GET_PREFERED_SITE_PACKAGES}" "--site-type" "local" "--prefer-pattern" "${CMAKE_INSTALL_PREFIX}"
...
if (COMPILE_PYTHON3_BINDINGS)
	...
	message(STATUS "Installation details:")
	message(STATUS "  Target: ${target_name}")
	message(STATUS "  Python version: ${python_version}")
	message(STATUS "  PROJECT_SOURCE_DIR: ${PROJECT_SOURCE_DIR}")
	message(STATUS "  Site-packages: ${PYTHON_${python_version}_SYSTEM_SITE_PACKAGES}")
	message(STATUS "HERE we have SITEPACKAGE:  ${PYTHON_${_python_version}_SYSTEM_SITE_PACKAGES}")
	...
	message(STATUS "------------output_name:${target_name}")
    ...
    function(_add_python_bindings module libname component)
        ...
        foreach(_python_version ${PYBIND11_PYTHON_VERSIONS})
            ...
            message(STATUS "_python_version=${_python_version}")
            ...
            if(ARG_INCLUDE_DIRECTORIES)
            	message(STATUS "11111111111111111111111111111")
    ...
    function(add_hal_python_bindings module)
        list(REMOVE_AT ARGV 0)
        set(REMAINING_ARGS ${ARGN})
        message(STATUS "1DSDDD111111111111111111${ARGN}1111111111111")
        if(WIN32)
        ...
        _add_python_bindings(${module} ${libname} ${component} ${REMAINING_ARGS})
    endfunction()

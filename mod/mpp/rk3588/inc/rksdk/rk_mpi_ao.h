...
RK_S32 RK_MPI_AO_SetAdvParam(AUDIO_DEV AoDevId, const AIO_ADVPARAM_S *pstAdvParam);
RK_S32 RK_MPI_AO_GetAdvParam(AUDIO_DEV AoDevId, AIO_ADVPARAM_S *pstAdvParam);

...
RK_S32 RK_MPI_AI_SetAdvParam(AUDIO_DEV AiDevId, const AIO_ADVPARAM_S *pstAdvParam);
RK_S32 RK_MPI_AI_GetAdvParam(AUDIO_DEV AiDevId, AIO_ADVPARAM_S *pstAdvParam);

...
typedef enum rkPIXEL_FORMAT_E {
    ...
    RK_FMT_YUV444SP_10BIT,                             /* YYYY... UVUVUVUV...      */
...
typedef enum rkQUANT_RANGE_E {
    QUANT_RANGE_FULL_RANGE = 0,
    QUANT_RANGE_LIMIT_RANGE,
    QUANT_RANGE_UNSPECIFIED,
    QUANT_RANGE_BUTT
} QUANT_RANGE_E;

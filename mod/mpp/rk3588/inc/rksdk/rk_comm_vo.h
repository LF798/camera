...
typedef enum rkVO_INTF_SYNC_E {
    ...
    VO_OUTPUT_3840x2160_120, /* 3840x2160_120 */
...
typedef enum rkVO_CSC_MATRIX_E {
    ...
    VO_CSC_MATRIX_BT601_TO_BT709, /* BT601 Limit to BT709 Limit */
    VO_CSC_MATRIX_BT709_TO_BT601, /* BT709 Limit to BT601 Limit */

    VO_CSC_MATRIX_BT601_TO_RGB_PC, /* BT601 Full to RGB Full */
    VO_CSC_MATRIX_BT709_TO_RGB_PC, /* BT709 Full to RGB Full */

    VO_CSC_MATRIX_RGB_TO_BT601_PC, /* RGB Full to BT601 FULL */
    VO_CSC_MATRIX_RGB_TO_BT709_PC, /* RGB Full to BT709 FULL */

    VO_CSC_MATRIX_RGB_TO_BT2020_PC, /* RGB Full to BT.2020 Full */
    VO_CSC_MATRIX_BT2020_TO_RGB_PC, /* BT.2020 Full to RGB Full */

    VO_CSC_MATRIX_RGB_TO_BT601_TV, /* RGB Full to BT601 LIMIT */
    VO_CSC_MATRIX_RGB_TO_BT709_TV, /* RGB Full to BT709 LIMIT */

    VO_CSC_MATRIX_BT601_TO_RGB_TV, /* BT601 Limit to RGB Full */
    VO_CSC_MATRIX_BT709_TO_RGB_TV, /* BT709 Limit to RGB Full */

    VO_CSC_MATRIX_RGB_TO_BT2020_TV, /* RGB Full to BT.2020 Limit */
    VO_CSC_MATRIX_BT2020_TO_RGB_TV, /* BT.2020 Limit to RGB Full */

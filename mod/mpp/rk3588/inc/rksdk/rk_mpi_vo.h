...
RK_S32 RK_MPI_VO_SetKeyColor(VO_LAYER VoLayer, RK_BOOL enable, RK_U32 KeyColor);
...
RK_S32 RK_MPI_VO_SetLayerFreeze(VO_LAYER VoLayer, RK_BOOL bFreezed);
RK_S32 RK_MPI_VO_GetLayerFreeze(VO_LAYER VoLayer, RK_BOOL *pbFreezed);

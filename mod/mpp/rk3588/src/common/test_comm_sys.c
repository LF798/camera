...
RK_S32 TEST_SYS_WbcBindVpss(VO_WBC WbcChn, VPSS_GRP VpssGrp) {
    RK_S32 s32Ret = RK_SUCCESS;
    MPP_CHN_S stSrcChn;
    MPP_CHN_S stDestChn;
...
RK_S32 TEST_SYS_WbcUnbindVpss(VO_WBC WbcChn, VPSS_GRP VpssGrp) {
    RK_S32 s32Ret = RK_SUCCESS;
    MPP_CHN_S stSrcChn;
    MPP_CHN_S stDestChn;
...
RK_S32 TEST_SYS_VdecBindVenc(VDEC_CHN VdecChn, VENC_CHN VencChn) {
    RK_S32 s32Ret = RK_SUCCESS;
    MPP_CHN_S stSrcChn;
    MPP_CHN_S stDestChn;
...
RK_S32 TEST_SYS_VdecUnbindVenc(VDEC_CHN VdecChn, VENC_CHN VencChn) {
    RK_S32 s32Ret = RK_SUCCESS;
    MPP_CHN_S stSrcChn;
    MPP_CHN_S stDestChn;
